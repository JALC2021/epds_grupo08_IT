...
<html>
    ...
    <body>
        ...
        <table border="1">
            ...
            <td><%= proyecto%></td>
             ...
             <td><%= bloque1+bloque2+bloque3+proyecto+ejercicios%></td>
              ...
              <% if(bloque1+bloque2+bloque3+proyecto+ejercicios>=5){%>
              <div>
                  <h2>Aprobado</h2>
                  <p>Enhorabuena, ha superado la asignatura</p>
                  </br>
                  <p>Enviar a:</p>
                  </br>
                  <%= direccion%>
              ...
              <div>
                  <h2>Suspenso</h2>
                  <p>Lo siento, solo ha superado el rendimiento individual</p>
                  </br>
                  <p>Enviar a:</p>
                  </br>
                  <%= direccion%>
        ...
        <p><strong>No se agrega rendimiento grupal por no llegar a 5 en individual</strong></p>
         ...
         <div>
             <h2>Suspenso</h2>
                  <p>Lo siento, no ha superado el rendimiento individual, por lo que no se puede agregar el rendimiento grupal</p>
                  </br>
                  <p>Enviar a:</p>
                  </br>
                  <%= direccion%>
