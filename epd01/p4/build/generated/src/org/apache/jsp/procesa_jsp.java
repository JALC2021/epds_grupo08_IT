...
public final class procesa_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <body>\n");
      out.write("    \n");
      out.write("           <!--        Vista de formulario-->\n");
      out.write("        <p>El siguiente formulario se utilizar&aacute; para saber si usted es apto para recibir un cr&eacute;dito</p>\n");
      out.write("        <p>Rellene el siguiente el formulario:</p>\n");
      out.write("        <form action=\"procesa.jsp\" method=\"post\">\n");
      out.write("\n");
      out.write("            <p> <label>Nombre: </label><input type=\"text\" name=\"nombre\"> </p>\n");
      out.write("\n");
      out.write("            <p><label>Apellidos: </label><input type=\"text\" name=\"apellidos\"> </p>\n");
      out.write("\n");
      out.write("            <p><label>Estado civil: </label><select name=\"estadoCivil\">\n");
      out.write("\n");
      out.write("                    <option value=\"soltero\">Soltero</option>\n");
      out.write("                    <option value=\"casado\">Casado</option>\n");
      out.write("                    <option value=\"casado\">Otros</option>\n");
      out.write("                </select></p>\n");
      out.write("\n");
      out.write("            <p><label>¿Trabaja?: </label><label>S&iacute;</label><input type=\"radio\" name=\"trabaja\" value=\"si\">\n");
      out.write("                <label>No</label><input type=\"radio\" name=\"trabaja\" value=\"no\"></p>\n");
      out.write("\n");
      out.write("            <p><label>Ingresos: </label><input type=\"text\" name=\"ingresos\"></p>\n");
      out.write("\n");
      out.write("            <p><label>Gastos: </label><input type=\"text\" name=\"gastos\"></p>\n");
