...
public class ObjectFactory {
    ...
    private final static QName _IsAlive_QNAME = new QName("http://paquete/", "isAlive");
    private final static QName _IsAliveResponse_QNAME = new QName("http://paquete/", "isAliveResponse");
    private final static QName _Login_QNAME = new QName("http://paquete/", "login");
    private final static QName _LoginResponse_QNAME = new QName("http://paquete/", "loginResponse");
    private final static QName _Logout_QNAME = new QName("http://paquete/", "logout");
    private final static QName _LogoutResponse_QNAME = new QName("http://paquete/", "logoutResponse");
    private final static QName _UsersRegistered_QNAME = new QName("http://paquete/", "usersRegistered");
    private final static QName _UsersRegisteredResponse_QNAME = new QName("http://paquete/", "usersRegisteredResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://paquete/", name = "isAlive")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://paquete/", name = "isAliveResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://paquete/", name = "login")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://paquete/", name = "loginResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://paquete/", name = "logout")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://paquete/", name = "logoutResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://paquete/", name = "usersRegistered")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://paquete/", name = "usersRegisteredResponse")
