 ...
 * USAGE:
 * <pre>
 *        ContadorJerseyClient client = new ContadorJerseyClient();
...
public class ContadorJerseyClient {
     ...
     * @param palabra query parameter
     * @return response object (instance of responseType class)
     */
    public <T> T getHtml(Class<T> responseType, String palabra) throws ClientErrorException {
        String[] queryParamNames = new String[]{"palabra"};
        String[] queryParamValues = new String[]{palabra};
        ;
