...
/**
 * Jersey REST client generated for REST resource:application-wadl-xml
 * [contrafuerte]<br>
 * USAGE:
 * <pre>
...
public class NewJerseyClient {
    ...
    public NewJerseyClient() {
        ...
        webTarget = client.target(BASE_URI).path("contrafuerte");
    }

    /**
     * @param responseType Class representing the response
     * @param longitud query parameter
     * @return response object (instance of responseType class)
     */
    public <T> T getHtml(Class<T> responseType, String longitud) throws ClientErrorException {
        String[] queryParamNames = new String[]{"longitud"};
        String[] queryParamValues = new String[]{longitud};
        ;
