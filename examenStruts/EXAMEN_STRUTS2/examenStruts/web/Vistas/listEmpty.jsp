<%-- 
    Document   : listEmpty
    Created on : 19-abr-2018, 18:47:39
    Author     : susana
--%>
...
<form id="nuevoAnimal" name="nuevoAnimal" onsubmit="return validateForm_nuevoAnimal();" action="/ItEv2STRUTS_2/reserva/actions/nuevoAnimal.action" method="post"  onreset="clearErrorMessages(this);clearErrorLabels(this);"
>
<table class="wwFormTable">
            <tr>
    <td class="tdLabel"><label for="nuevoAnimal_identificador" class="label">Identifier of the animal:</label></td>
    <td
><input type="text" name="identificador" value="" id="nuevoAnimal_identificador"/></td>
</tr>
    ...
    <td
><select name="tipoAnimal" id="nuevoAnimal_tipoAnimal">
    ...
    <td
><input type="text" name="pais" value="" id="nuevoAnimal_pais"/></td>
</tr>
    ...
    <td
><input type="text" name="precio" value="" id="nuevoAnimal_precio"/></td>
</tr>
    ...
    <td
><input type="text" name="email" value="" id="nuevoAnimal_email"/></td>
</tr>
